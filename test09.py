# สร้างโปรแกรมคำนวณเงินเดือนสุทธิที่ต้องจ่ายหลังจากหักภาษีแล้ว 7% และหักค่าประกันสังคม 3%
# โดยรับค่ารหัสพนักงาน ชื่อพนักงาน ทางแป้นพิมพ์ และแสดงข้อมูลที่ได้รับมา
...
print(f'ประกันสังคม :{insurence} บาท')
...
print('ประกันสังคม :',insurence,' บาท')
print('ต้องจ่ายเงินเดือนสุทธิ :',emp_salary_net,' บาท')
print('-------------------------------------------------------------')
# ใช้ +
print('รหัส :'+str(emp_code)+'ชื่อ :'+str(emp_name)+'เงินเดือน :'+str(emp_salary))
print('หักภาษี :'+str(tax)+'บาท')
print('ประกันสังคม :'+str(insurence)+'บาท')
print('ต้องจ่ายเงินเดือนสุทธิ :'+str(emp_salary_net))
print('-------------------------------------------------------------')
# ใช้เมธอด format
print('รหัส : {} ชื่อ : {} เงินเดือน : {}'.format(emp_code,emp_name,emp_salary))
print('หักภาษี : {} บาท'.format(tax))
print('ประกันสังคม : {} บาท'.format(insurence))
